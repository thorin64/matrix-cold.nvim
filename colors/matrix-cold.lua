...
local highlights        = {
	...
	Number                            = { fg = colors.light6 },
	Boolean                           = { fg = colors.light4 },
	Float                             = { fg = colors.light6 },
	...
	Type                              = { fg = colors.light6 },
	StorageClass                      = { fg = colors.light6 },
	...
	["@number"]                       = { fg = colors.light6 },
	["@float"]                        = { fg = colors.light6 },
	["@boolean"]                      = { fg = colors.light5 },

	["@type"]                         = { fg = colors.light6, bold = true },
	["@type.builtin"]                 = { fg = colors.light3, bold = true },
	["@type.definition"]              = { fg = colors.light2, bold = true },
	...
	["@text.reference"]               = { fg = colors.light6 },
	...
	------------------------- RUST SPECIFIC -------------------------
	rustFoldBraces                    = { fg = colors.light6 },
	rustFoldParens                    = { fg = colors.neon },
	rustFoldBrackets                  = { fg = colors.mid },
	rustStructure                     = { fg = colors.neon },
	rustType                          = { fg = colors.light6, bold = true },
	rustEnum                          = { fg = colors.light6, bold = true },
	rustTrait                         = { fg = colors.light6, bold = true },
	rustModPath                       = { fg = colors.neon },
	rustModPathSep                    = { fg = colors.mid },
	rustArrow                         = { fg = colors.neon },
	rustFatArrow                      = { fg = colors.neon },
	rustQuestionMark                  = { fg = colors.light2 },
	rustAttribute                     = { fg = colors.mid },
	rustMacro                         = { fg = colors.light3, bold = true },
	rustLifetime                      = { fg = colors.light4 },
	rustSelf                          = { fg = colors.light2 },
	rustSuper                         = { fg = colors.light2 },
	rustEnumVariant                   = { fg = colors.light4 },
	rustField                         = { fg = colors.light4 },
	rustIntegerLiteral                = { fg = colors.light6 },
	rustFloatLiteral                  = { fg = colors.light6 },
	rustStringLiteral                 = { fg = colors.mid },
	rustEscape                        = { fg = colors.light4 },
	rustFormatSpecifier               = { fg = colors.light4 },
	rustCommentLine                   = { fg = colors.gray, italic = use_italic },
	rustCommentBlock                  = { fg = colors.gray, italic = use_italic },
	rustCommentLineDoc                = { fg = colors.gray, italic = use_italic },
	rustCommentBlockDoc               = { fg = colors.gray, italic = use_italic },
	rustKeyword                       = { fg = colors.neon },
	rustFunction                      = { fg = colors.neon, bold = true },
	rustVariable                      = { fg = colors.white },
	rustConstant                      = { fg = colors.mid },
	rustOperator                      = { fg = colors.light2 },
	rustDerive                        = { fg = colors.light3, bold = true },
	rustPubScope                      = { fg = colors.mid },
	rustVisScope                      = { fg = colors.mid },
	rustUnsafe                        = { fg = colors.neon },
	rustExternCrate                   = { fg = colors.neon },
	rustUse                           = { fg = colors.neon },
	rustMod                           = { fg = colors.neon },
	rustStruct                        = { fg = colors.neon },
	rustImpl                          = { fg = colors.neon },
	rustFn                            = { fg = colors.neon },
	rustLet                           = { fg = colors.neon },
	rustMut                           = { fg = colors.neon },
	rustRef                           = { fg = colors.light2 },
	rustReturn                        = { fg = colors.neon },
	rustMatch                         = { fg = colors.neon },
	rustFor                           = { fg = colors.neon },
	rustIn                            = { fg = colors.neon },
	rustIf                            = { fg = colors.neon },
	rustElse                          = { fg = colors.neon },
	rustLoop                          = { fg = colors.neon },
	rustWhile                         = { fg = colors.neon },
	rustBreak                         = { fg = colors.neon },
	rustContinue                      = { fg = colors.neon },
	rustAs                            = { fg = colors.neon },
	rustWhere                         = { fg = colors.neon },
	rustStatic                        = { fg = colors.neon },
	rustConst                         = { fg = colors.neon },
	rustCrate                         = { fg = colors.neon },
	rustTrue                          = { fg = colors.light4 },
	rustFalse                         = { fg = colors.light4 },
	rustInteger                       = { fg = colors.light6 },
	rustFloat                         = { fg = colors.light6 },
	rustString                        = { fg = colors.mid },
	rustChar                          = { fg = colors.mid },
	rustParen                         = { fg = colors.neon },
	rustBracket                       = { fg = colors.neon },
	rustBrace                         = { fg = colors.neon },
	rustAngleBracket                  = { fg = colors.neon },
	rustPipe                          = { fg = colors.light2 },
	rustAnd                           = { fg = colors.light2 },
	rustOr                            = { fg = colors.light2 },
	rustNot                           = { fg = colors.light2 },
	rustPlus                          = { fg = colors.light2 },
	rustMinus                         = { fg = colors.light2 },
	rustStar                          = { fg = colors.light2 },
	rustSlash                         = { fg = colors.light2 },
	rustPercent                       = { fg = colors.light2 },
	rustCaret                         = { fg = colors.light2 },
	rustTilde                         = { fg = colors.light2 },
	rustAmpersand                     = { fg = colors.light2 },
	rustVerticalBar                   = { fg = colors.light2 },
	rustLessThan                      = { fg = colors.neon },
	rustGreaterThan                   = { fg = colors.neon },
	rustEqual                         = { fg = colors.light2 },
	rustBang                          = { fg = colors.light2 },
	rustQuestion                      = { fg = colors.light2 },
	rustAt                            = { fg = colors.mid },
	rustHash                          = { fg = colors.mid },
	rustDollar                        = { fg = colors.light2 },
	rustUnderscore                    = { fg = colors.light2 },
	rustColon                         = { fg = colors.mid },
	rustSemicolon                     = { fg = colors.mid },
	rustComma                         = { fg = colors.mid },
	rustDot                           = { fg = colors.mid },
	...
	lualine_a_command                 = { bg = colors.mid, fg = colors.black, bold = true },
